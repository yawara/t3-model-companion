...
TeX: T3_modelcompanion_v4.tex, `example:Grassmann algebra`, v4 Example 2.9.
...
TeX: T3_modelcompanion_v4.tex, `proposition:gr of free product`, natural exterior decomposition.
-/
