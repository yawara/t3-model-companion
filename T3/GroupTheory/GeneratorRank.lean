...
TeX: T3_modelcompanion_v4.tex, Notation 2.1(7), `lemma:commutator root`,
`lemma:number of generators for triple commutator roots`, lines 1084–1086 and 1144–1145.
-/
...
TeX: T3_modelcompanion_v4.tex, Notation 2.1, item 7, minimum number of generators.
-/
...
Paper-ID: preliminaries.notation.generator_rank, structure.derived_strictification,
structure.lcs_strictification
TeX: T3_modelcompanion_v4.tex, `lemma:commutator root` and
...
TeX: T3_modelcompanion_v4.tex, `proposition:gr(F) is Grassmann algebra`, degree one.
-/
...
TeX: T3_modelcompanion_v4.tex, `lemma:commutator root`, the finite-dimensional basis choice.
-/
...
Paper-ID: structure.derived_strictification
TeX: T3_modelcompanion_v4.tex, `lemma:commutator root`, `dim gr₁(C) ≤ m`.
-/
...
Paper-ID: preliminaries.notation.generator_rank, structure.lcs_strictification
TeX: T3_modelcompanion_v4.tex, Notation 2.1(7),
