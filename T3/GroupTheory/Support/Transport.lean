...
TeX: T3_modelcompanion_v7.tex, `thm:main`, the passage from `H₀` to `D ∐ B`, line 816.
-/
...
Paper-ID: main.bounded_witness
TeX: T3_modelcompanion_v7.tex, `thm:main`, the inclusion of `H₀` in the smaller coproduct.
-/
...
Paper-ID: main.bounded_witness
TeX: T3_modelcompanion_v7.tex, `thm:main`, the certificate in `D ∐ B` on line 816.
-/
