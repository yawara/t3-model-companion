...
TeX: T3_modelcompanion_v7.tex, `lemma:gr of quotient`, v7 Lemma 2.31.
-/
...
TeX: T3_modelcompanion_v7.tex, `lemma:gr of quotient`, applied in
`proposition:gr of free product`, proof lines 956–962.
-/
