...
TeX: T3_modelcompanion_v4.tex, `lemma:gr of quotient`, v4 Lemma 2.31.
-/
...
TeX: T3_modelcompanion_v4.tex, `lemma:gr of quotient`, applied in
`proposition:gr of free product`, proof lines 875–881.
-/
