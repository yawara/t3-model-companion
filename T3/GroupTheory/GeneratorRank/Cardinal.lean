...
TeX: T3_modelcompanion_v4.tex, Notation 2.1, item 7, line 155.
-/
...
Paper-ID: preliminaries.notation.generator_rank
TeX: T3_modelcompanion_v4.tex, Notation 2.1, item 7, and every finite generator bound.
-/
...
Paper-ID: preliminaries.notation.generator_rank
TeX: T3_modelcompanion_v4.tex, Notation 2.1, item 7.
-/
