...
TeX: T3_modelcompanion_v4.tex, `proposition:gr of free product`, proof, lines 899–920.
-/
...
Paper-ID: structure.graded_coproduct
TeX: T3_modelcompanion_v4.tex, `proposition:gr of free product`, factor retractions.
-/
...
Paper-ID: structure.graded_coproduct
TeX: T3_modelcompanion_v4.tex, `proposition:gr of free product`, factor graded inclusions.
-/
...
Paper-ID: structure.graded_coproduct
TeX: T3_modelcompanion_v4.tex, `proposition:gr of free product`, factor inclusions.
-/
...
Paper-ID: structure.graded_coproduct
TeX: T3_modelcompanion_v4.tex, `proposition:gr of free product`, identification of `Rₙ` and `Sₙ`.
-/
