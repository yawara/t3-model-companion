...
v8 Proposition 2.29 and Remark 2.30, lines 634–686.
-/
...
Paper-ID: preliminaries.free_graded_equiv, preliminaries.infinite_free_graded
TeX: T3_modelcompanion_v8.tex, `proposition:gr(F) is Grassmann algebra`, degree three.
-/
...
Paper-ID: preliminaries.free_graded_equiv, preliminaries.infinite_free_graded
TeX: T3_modelcompanion_v8.tex, `proposition:gr(F) is Grassmann algebra`, item 1.
-/
...
Paper-ID: preliminaries.free_graded_equiv, preliminaries.infinite_free_graded
TeX: T3_modelcompanion_v8.tex, `proposition:gr(F) is Grassmann algebra`, item 2.
-/
...
Paper-ID: preliminaries.free_graded_equiv, preliminaries.infinite_free_graded
TeX: T3_modelcompanion_v8.tex, `proposition:gr(F) is Grassmann algebra`, item 3.
-/
