...
TeX: T3_modelcompanion_v7.tex, `proposition:bounded number of conjugates`, v7 Proposition 3.1.
-/
...
Paper-ID: main.conjugate_width
TeX: T3_modelcompanion_v7.tex, `proposition:bounded number of conjugates`,
v7 Proposition 3.1. -/
