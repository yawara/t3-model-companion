...
TeX: T3_modelcompanion_v8.tex, v8 Notation 2.1(8), Fact 2.16, and Lemma 2.17.
-/
...
TeX: T3_modelcompanion_v8.tex, v8 Notation 2.1, item 8.
-/
...
TeX: T3_modelcompanion_v8.tex, v8 Lemma 2.17.
-/
...
Paper-ID: preliminaries.coproduct_factor_injective
TeX: T3_modelcompanion_v8.tex, v8 Lemma 2.17 and its proof.
-/
...
TeX: T3_modelcompanion_v8.tex, `proposition:gr of free product`, naturality of the factor maps.
-/
...
TeX: T3_modelcompanion_v8.tex, v8 Fact 2.16.
-/
