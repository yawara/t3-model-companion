...
TeX: T3_modelcompanion_v7.tex, `proposition:gr of free product`, item 1, lines 924–1007.
-/
...
Paper-ID: structure.graded_coproduct
TeX: T3_modelcompanion_v7.tex, `proposition:gr of free product`, bijectivity of `η₂`.
-/
