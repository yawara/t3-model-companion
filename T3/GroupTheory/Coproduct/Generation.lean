...
TeX: T3_modelcompanion_v8.tex, `proposition:bdd LCS`, lines 1321–1340.
-/
...
Paper-ID: structure.strict_envelope
TeX: T3_modelcompanion_v8.tex, `proposition:bdd LCS`, generation of the free product.
-/
...
Paper-ID: structure.strict_envelope
TeX: T3_modelcompanion_v8.tex, `proposition:bdd LCS`, finite generation of `D₃`.
-/
...
Paper-ID: structure.strict_envelope
TeX: T3_modelcompanion_v8.tex, `proposition:bdd LCS`, the generator count for `D₃`.
-/
...
Paper-ID: structure.strict_envelope
TeX: T3_modelcompanion_v8.tex, `proposition:bdd LCS`, lines 1331–1336.
-/
