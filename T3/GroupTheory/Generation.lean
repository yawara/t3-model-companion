...
Paper-ID: structure.basis_lift
TeX: T3_modelcompanion_v4.tex, `proposition:lift`, first commutator inclusion.
-/
...
Paper-ID: structure.basis_lift
TeX: T3_modelcompanion_v4.tex, `proposition:lift`, first displayed commutator inclusion.
-/
...
Paper-ID: structure.basis_lift
TeX: T3_modelcompanion_v4.tex, `proposition:lift`, second displayed commutator inclusion.
-/
...
Paper-ID: structure.basis_lift
TeX: T3_modelcompanion_v4.tex, `proposition:lift`, conclusion of the two inclusions.
-/
...
Paper-ID: structure.basis_lift
TeX: T3_modelcompanion_v4.tex, `proposition:lift`, subgroup generation conclusion.
-/
