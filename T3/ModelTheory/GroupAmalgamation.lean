...
TeX: T3_modelcompanion_v4.tex, `thm:main`, lines 703–745, and
...
TeX: T3_modelcompanion_v4.tex, `thm:main`, the symmetric witness cases.
-/
...
Paper-ID: main.bounded_witness, main.model_companion
TeX: T3_modelcompanion_v4.tex, `thm:main`, and the deduction from the amalgamation criterion.
-/
...
Paper-ID: main.bounded_witness, main.model_companion
TeX: T3_modelcompanion_v4.tex, `thm:main`, applying the amalgamation criterion.
-/
