...
TeX: T3_modelcompanion_v7.tex, Definition 2.4, lines 282–285; no label.
The finite-diagram consequence is Definition 2.2, item 6, lines 271–272.
-/
...
Paper-ID: model_theory.local_finiteness
TeX: T3_modelcompanion_v7.tex, Definition 2.4; no label.
-/
