...
TeX: T3_modelcompanion_v8.tex, Definition 2.2, item 4, line 267; no label.

Paper-ID: model_theory.companion_iff_ec
TeX: T3_modelcompanion_v8.tex, Fact 2.3, lines 279–285; no label.
-/
...
Paper-ID: model_theory.basic_definitions
TeX: T3_modelcompanion_v8.tex, Definition 2.2, items 3 and 4; no label.
-/
...
Paper-ID: model_theory.basic_definitions
TeX: T3_modelcompanion_v8.tex, supporting Definition 2.2(6) and Proposition 4.13,
