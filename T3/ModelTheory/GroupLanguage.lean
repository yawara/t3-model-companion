...
TeX: T3_modelcompanion_v4.tex, the group-language and group-theory convention, lines 136–142.
-/
...
Paper-ID: preliminaries.exponent_three
TeX: T3_modelcompanion_v4.tex, the language convention, lines 136–138.
-/
...
TeX: T3_modelcompanion_v4.tex, lines 136–142, 203–206.
-/
...
Paper-ID: preliminaries.exponent_three, model_theory.local_finiteness
TeX: T3_modelcompanion_v4.tex, applying Definition 2.4 to the group language.
-/
