...
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, lines 246–252.
-/
...
Paper-ID: model_theory.bounded_amalgamation_criterion
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, line 252.
-/
...
Paper-ID: model_theory.bounded_amalgamation_criterion
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, marked types on
line 252.
-/
...
Paper-ID: model_theory.bounded_amalgamation_criterion
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, lines 246–250.
-/
...
Paper-ID: model_theory.bounded_amalgamation_criterion
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, `K(A,B)`.
-/
...
Paper-ID: model_theory.bounded_amalgamation_criterion
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, item 1, line 248.
-/
...
Paper-ID: model_theory.bounded_amalgamation_criterion
TeX: T3_modelcompanion_v4.tex, `fact:locally finiteness and model companion`, item 2, line 249.
-/
