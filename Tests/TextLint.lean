...
This program discovers `T3.lean` and every Lean source file below `T3`, then applies the pinned
Mathlib text and module-name linters with no exceptions. It does not modify any source files.
